...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Performance file review")
    parser.add_argument(
        "-i", "--input_file", help="Input html filename with full path", required=True
    )
    ...
    # Build dictionary of interesting config

    try:
        sp_dict = mainline(input_file)
        build_log(sp_dict)
    except OSError as e:
